      ...
      <Container>
        ...
        <Row className="resume">
          <Col md={6} className="resume-left">
            ...
            <Resumecontent
              title="Senior Information Security Analyst [Telefônica]"
              date="July 2018 - September 2019"
              content={[
                "Company server monitoring services, network traffic monitoring, malware analysis (Worms, Trojans, Botnets, Rookits, Ransowares, Scarewares), phishings (Scam, Spear), Spams, Pharmings, assistance and guidance from the team of analysts at solving problems that require further Critical analysis.",
              ]}
            />
